...
```{r}
write_csv(day1.simplified, "../data/day1_simplified.csv")
write_csv(day2.simplified, "../data/day2_simplified.csv")
write_csv(day2.simplified, "../data/day3_simplified.csv")
```
